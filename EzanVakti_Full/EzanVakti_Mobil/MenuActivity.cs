...
namespace EzanVakti_Mobil
{
    ...
    {
        LinearLayoutCompat settingbtn,locationbtn,miladibtn,hicribtn,kuranbtn,pusulabtn,dinigunlerbtn;
     ...
     SetContentView(Resource.Layout.activity_menu);
            ...
            pusulabtn = FindViewById<LinearLayoutCompat>(Resource.Id.menuLlytCompassBtn);
        ...
        public void dinigunlerClick(View v)
        {
